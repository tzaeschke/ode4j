...
public class TestDQuaternion extends OdeTestCase {
	...
	public void testOther() {
		...
		t.set(3, 4, -18, -6.5);
		t.normalize();
		assertEquals(new DQuaternion(0.15166804174966758, 0.20222405566622345,
				-0.9100082504980056, -0.32861409045761314), t);
		...
		// t.set(3, 4, -18, -6.5);
		// t.normalize();
		// assertEquals(new dQuaternion(0.16058631827165676,
		// 0.21411509102887566, -0.9635179096299405, 0.1), t);
	...
	// dQuaternion t = new dQuaternion();
	//
	// dMatrix3 B = new dMatrix3(0.10, 0.11, 0.12, 1.10, 1.11, 1.12, 2.10, 2.11,
	// 2.22);
