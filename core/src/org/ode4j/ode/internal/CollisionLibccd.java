...
//                                dContactGeom *contact, int skip);
    ...
    //TODO TZ ************ LIB-CCD stuff
    private static class ccd_vec3_t {};
    private static class ccd_quat_t {};
    private static class ccd_real_t {};
    //TODO TZ ************ LIB-CCD stuff
    ...
    private static class ccd_box_t {
        ccd_obj_t o;
        ccd_real_t[] dim = new ccd_real_t[3];
    };
...
//    }
//
//    static void ccdGeomToBox(final DGeom g, ccd_box_t box)
//    {
//        DVector3 dim;
//
...
//    }
//
//    static void ccdGeomToCap(final DGeom g, ccd_cap_t cap)
//    {
//        RefDouble r, h;
...
//    }
//
//    static void ccdGeomToCyl(final DGeom g, ccd_cyl_t cyl)
//    {
//        double r, h;
...
//    }
//
//    static void ccdGeomToSphere(final DGeom g, ccd_sphere_t s)
//    {
//        ccdGeomToObj(g, (ccd_obj_t)s);
//        s.radius = dGeomSphereGetRadius(g);
//    }
//
//    static void ccdGeomToConvex(final DGeom g, ccd_convex_t c)
//    {
...
//
//
//    static void ccdSupportBox(final Object obj, final ccd_vec3_t _dir, ccd_vec3_t v)
//    {
...
//    }
//
//    static void ccdSupportCap(final Object obj, final ccd_vec3_t _dir, ccd_vec3_t v)
//    {
...
//    }
//
//    static void ccdSupportCyl(final Object obj, final ccd_vec3_t _dir, ccd_vec3_t v)
//    {
...
//    }
//
//    static void ccdSupportSphere(final Object obj, final ccd_vec3_t _dir, ccd_vec3_t v)
//    {
...
//    }
//
//    static void ccdSupportConvex(final Object obj, final ccd_vec3_t[] _dir, ccd_vec3_t[] v)
//    {
...
//    }
//
//    static void ccdCenter(final Object obj, ccd_vec3_t[] c)
//    {
//        final ccd_obj_t o = (ccd_obj_t)obj;
//        ccdVec3Copy(c, o.pos);
//    }
//
//    static int ccdCollide(DGeomID o1, DGeomID o2, int flags,
