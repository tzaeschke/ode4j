 ...
 * 
 * This interface should only be implemented by DVector3. This allows efficient
 * optimisation by the JVM, which is not possible with 2 (still somewhat
 * efficient) or more (slow) sub-classes.
 * 
 * @author Tilmann Zaeschke
 */
public interface DVector3C extends DVector3I {
