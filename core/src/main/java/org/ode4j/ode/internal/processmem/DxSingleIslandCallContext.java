...
public class DxSingleIslandCallContext {
	DxSingleIslandCallContext(DxIslandsProcessingCallContext islandsProcessingContext, 
			...
			DxBody[] islandBodiesStart, DxJoint[] islandJointsStart) {
		...
		m_stepperCallContext = new DxStepperProcessingCallContext(islandsProcessingContext.m_world, 
				...
				stepperArena, islandBodiesStart, islandJointsStart);
	}
	...
	{
		m_stepperCallContext.AssignIslandSelection(islandBodiesStart, islandJointsStart, 
				islandBodiesCount, islandJointsCount);
	}

	DxBody[] GetSelectedIslandBodiesEnd() { 
		return m_stepperCallContext.GetSelectedIslandBodiesEnd(); }
	DxJoint[] GetSelectedIslandJointsEnd() { 
