...
public class TestMPRBoxBox {

	private static final void assertTrue(int i) {
		assertTrue(i != 0);
	}

	private static final void assertFalse(int i) {
		assertTrue(i == 0);
	}

	private static final void assertTrue(boolean i) {
		Assert.assertTrue(i);
	}

	@Test
	public void mprBoxboxAlignedX()
	{
	    int i;
	    ccd_t ccd = new ccd_t();
	...
	static void pConf(ccd_box_t box1, ccd_box_t box2, final ccd_vec3_t v)
	{
...
//	    svtObjPen(box1, box2, stdout, "Pen 1", depth, dir, pos)
	...
	@Test
	public void mprBoxboxPenetration()
	{
	    ccd_t ccd = new ccd_t();
	    ccd_box_t box1 = CCD_BOX();
	    ccd_box_t box2 = CCD_BOX();
